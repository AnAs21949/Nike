            ...
            <div className="flex flex-col items-start">
                ...
                <div className="flex items-center gap-5 mt-8">
                  {socialMedia.map((icon) => (
                    <div key={icon.alt} className="flex justify-center items-center w-12 h-12
                    bg-white rounded-full
                    ">
                      <img src={icon.src} alt={icon.alt} width={24} height={24} className="cursor-pointer" />
                    </div>
                  ))}
                </div>
            </div>
            ...
            ">
                {footerLinks.map((section)=>(
                    <div key={section}>
                        ...
                        font-montserrat text-2xl leading-normal font-medium
                        mb-6
                        ">{section.title}</h4>
                        <ul>
